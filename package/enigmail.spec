...
Version:   0.65.2
Release:   1
Requires:  mozilla = 1.1, mozilla-mail = 1.1, mozilla-enigmime = 0.65.1
...
%install
cd ${RPM_PACKAGE_NAME}-${RPM_PACKAGE_VERSION}
install -m 755 components/enigmail.xpt /usr/lib/mozilla-1.1/components
install -m 755 components/enigmail.js  /usr/lib/mozilla-1.1/components
install -m 755 chrome/enigmail.jar     /usr/lib/mozilla-1.1/chrome

%pre

%post

if [ -f /usr/lib/mozilla-1.1/chrome/installed-chrome.txt ]; then

  cat << EOF >> /usr/lib/mozilla-1.1/chrome/installed-chrome.txt
...
if [ -f /usr/lib/mozilla-1.1/mozilla-rebuild-databases.pl ]; then
    /usr/lib/mozilla-1.1/mozilla-rebuild-databases.pl
fi
...
/usr/lib/mozilla-1.1/components/enigmail.xpt
/usr/lib/mozilla-1.1/components/enigmail.js
/usr/lib/mozilla-1.1/chrome/enigmail.jar
